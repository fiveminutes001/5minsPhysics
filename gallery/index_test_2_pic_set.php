...
<script>
	...
	<div id="menu_div_02">
		<div id="div_15" class="col_left col_l"><img id="img_15" style="width:100%;" src="IMG_E9323.JPG"></div>
		<div id="div_16" class="col_middle col_m"><img id="img_16" style="width:100%;" src="img/02.jpg"></div>
		<div id="div_17" class="col_right col_r"><img id="img_17" style="width:100%;" src="img/03.jpeg"></div>
		<div id="div_18" class="col_left col_l"><img id="img_18" style="width:100%;" src="img/04.jpeg"></div>
		<div id="div_19" class="col_right col_r"><img id="img_19" style="width:100%;" src="img/05.jpeg"></div>
		<div id="div_20" class="col_middle col_m"><img id="img_20" style="width:100%;" src="img/01.jpeg"></div>
		<div id="div_21" class="col_left col_l"><img id="img_21" style="width:100%;" src="img/02.jpg"></div>
		<div id="div_22" class="col_left col_l"><img id="img_22" style="width:100%;" src="img/03.jpeg"></div>
		<div id="div_23" class="col_middle col_m"><img id="img_23" style="width:100%;" src="img/04.jpeg"></div>
		<div id="div_24" class="col_middle col_m"><img id="img_24" style="width:100%;" src="img/05.jpeg"></div>
		<div id="div_25" class="col_right col_r"><img id="img_25" style="width:100%;" src="img/01.jpeg"></div>
		<div id="div_26" class="col_right col_r"><img id="img_26" style="width:100%;" src="img/02.jpg"></div>
		<div id="div_27" class="col_left col_l"><img id="img_27" style="width:100%;" src="img/03.jpeg"></div>
		<div id="div_28" class="col_right col_r"><img id="img_28" style="width:100%;" src="img/04.jpeg"></div>
...
//TOP FOR MENU DIV 02
var menu_outer_height = $('#menu_div').outerHeight();
top_div_value = top_div_value + menu_outer_height;
$('#menu_div_02').css("top",top_div_value);
...
//ending loader	
	...
	$('#menu_div,#menu_div_02').animate({opacity:1},1000);
